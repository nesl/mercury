function [ rootMeanSquare ] = time_gps_series_compare( seriesGnd, seriesEstimation )
...
%   the root mean square of the distance differences.
...
distance = zeros(size(gndLatLng, 1), 1);
