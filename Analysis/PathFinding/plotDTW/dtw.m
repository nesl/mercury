function [Dist,D,k,w,rw,tw]=dtw(r,t,pflag,tcolor)
%
...
%}
    ...
    plot(fliplr(r),M:-1:1,'-b');
    set(left1, 'XTick',[], 'XTickLabel',[])
    set(left1, 'YTick',[], 'YTickLabel',[])
    ...
    set(bottom1, 'XTick',[], 'XTickLabel',[])
    set(bottom1, 'YTick',[], 'YTickLabel',[])
