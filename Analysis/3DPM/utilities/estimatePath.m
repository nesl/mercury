function [path, speed] = estimatePath(baroRaw, accRaw, gyroRaw)
% [path] = estimatePath(barowRaw, accRaw, gyroRaw)
...
%% Activity Detection
% for now, we're just going to assume they were driving.
